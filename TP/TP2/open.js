...
function askOverdraft() {
    do {
        ...
        operations.push({ "type": "createOverdraft", "amount": overdraft, "accepted": (overdraft >= 100 && overdraft <= 2000) })
...
function askSold() {
    do {
        ...
        sold = parseInt(sold)
        operations.push({ "type": "createSold", "amount": sold, "accepted": (sold >= 500) })
    }
    while (sold < 500)
    return sold
}
